...
class PlaceOrder extends AbstractListModel implements ComboBoxModel,KeyListener,ItemListener,ActionListener
 {
    ...
    public PlaceOrder() 
	{
		...
		//f.setContentPane(new JLabel(new ImageIcon("C:/Users/lenovo/Desktop/project4FF/Picture/placeorder.jpg")));
	...
	public void actionPerformed(ActionEvent a)
	{
		...
		{
			JOptionPane.showMessageDialog(null,"You can't add any more Food !!");
		}
